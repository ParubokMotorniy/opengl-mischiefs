/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sat Sep 27 15:04:38 2025.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --extensions="GL_AMD_conservative_depth,GL_AMD_draw_buffers_blend,GL_AMD_gpu_shader_int64,GL_AMD_performance_monitor,GL_AMD_query_buffer_object,GL_AMD_shader_stencil_export,GL_AMD_texture_texture4,GL_AMD_vertex_shader_viewport_index,GL_ARB_bindless_texture,GL_ARB_buffer_storage,GL_ARB_clip_control,GL_ARB_compressed_texture_pixel_storage,GL_ARB_conservative_depth,GL_ARB_cull_distance,GL_ARB_depth_clamp,GL_ARB_draw_buffers,GL_ARB_draw_instanced,GL_ARB_fragment_coord_conventions,GL_ARB_fragment_shader,GL_ARB_framebuffer_object,GL_ARB_get_program_binary,GL_ARB_gpu_shader5,GL_ARB_half_float_pixel,GL_ARB_indirect_parameters,GL_ARB_internalformat_query,GL_ARB_invalidate_subdata,GL_ARB_map_buffer_range,GL_ARB_occlusion_query2,GL_ARB_pipeline_statistics_query,GL_ARB_point_sprite,GL_ARB_program_interface_query,GL_ARB_query_buffer_object,GL_ARB_robustness,GL_ARB_seamless_cube_map,GL_ARB_separate_shader_objects,GL_ARB_shader_atomic_counters,GL_ARB_shader_bit_encoding,GL_ARB_shader_draw_parameters,GL_ARB_shader_image_load_store,GL_ARB_shader_objects,GL_ARB_shader_stencil_export,GL_ARB_shader_subroutine,GL_ARB_shader_texture_lod,GL_ARB_shading_language_420pack,GL_ARB_shading_language_packing,GL_ARB_sparse_texture,GL_ARB_stencil_texturing,GL_ARB_texture_barrier,GL_ARB_texture_buffer_object,GL_ARB_texture_buffer_range,GL_ARB_texture_compression_rgtc,GL_ARB_texture_filter_anisotropic,GL_ARB_texture_float,GL_ARB_texture_mirror_clamp_to_edge,GL_ARB_texture_mirrored_repeat,GL_ARB_texture_multisample,GL_ARB_texture_non_power_of_two,GL_ARB_texture_query_lod,GL_ARB_texture_rgb10_a2ui,GL_ARB_texture_storage,GL_ARB_texture_swizzle,GL_ARB_transform_feedback2,GL_ARB_transform_feedback_instanced,GL_ARB_transform_feedback_overflow_query,GL_ARB_vertex_array_bgra,GL_ARB_vertex_attrib_64bit,GL_ARB_vertex_buffer_object,GL_ARB_vertex_type_10f_11f_11f_rev,GL_ARB_viewport_array,GL_ATI_texture_float,GL_EXT_EGL_image_storage,GL_EXT_EGL_sync,GL_EXT_debug_label,GL_EXT_depth_bounds_test,GL_EXT_framebuffer_blit,GL_EXT_framebuffer_multisample,GL_EXT_framebuffer_multisample_blit_scaled,GL_EXT_framebuffer_sRGB,GL_EXT_packed_depth_stencil,GL_EXT_shader_image_load_formatted,GL_EXT_shader_integer_mix,GL_EXT_texture_array,GL_EXT_texture_compression_rgtc,GL_EXT_texture_filter_anisotropic,GL_EXT_texture_integer,GL_EXT_texture_sRGB_R8,GL_EXT_texture_shadow_lod,GL_EXT_texture_snorm,GL_EXT_timer_query,GL_IBM_multimode_draw_arrays,GL_KHR_blend_equation_advanced,GL_KHR_debug,GL_KHR_robust_buffer_access_behavior,GL_KHR_shader_subgroup"
    Online:
        Too many extensions
*/
